...
@section('content')
    ...
    <div style="margin-bottom: 2rem;">
        <h2 style="font-size: 1.5rem; font-weight: 700; color: #000000; margin-bottom: 0.5rem;">Menu Domini</h2>
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(400px, 1fr)); gap: 2rem;">
        ...
        <a href="{{ route('admin.menu.categories.index') }}" style="text-decoration: none;">
            <div class="card" style="height: 100%; transition: all 0.3s; cursor: pointer; border: 2px solid transparent;">
                <div style="padding: 2rem;">
                    <!-- Icon -->
                    <div style="width: 80px; height: 80px; background: linear-gradient(135deg, #FF0000, #CC0000); border-radius: 16px; display: flex; align-items: center; justify-content: center; margin-bottom: 1.5rem;">
                    ...
                    <!-- Content -->
                    <h3 style="font-size: 1.5rem; font-weight: 800; color: #000000; margin-bottom: 1rem;">
                        Gestion des Catégories
                    </h3>
                    ...
                    <ul style="list-style: none; padding: 0; margin-bottom: 2rem;">
                        <li style="display: flex; align-items: center; gap: 0.5rem; color: #666; font-size: 0.875rem; margin-bottom: 0.5rem;">
                            <svg style="width: 16px; height: 16px; color: #FF0000;" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <div style="display: flex; align-items: center; justify-content: space-between; padding-top: 1.5rem; border-top: 1px solid #E5E5E5;">
                        <span style="font-weight: 600; color: #FF0000;">Gérer les catégories</span>
        ...
        <a href="{{ route('admin.menu.plats.index') }}" style="text-decoration: none;">
            <div class="card" style="height: 100%; transition: all 0.3s; cursor: pointer; border: 2px solid transparent;">
                <div style="padding: 2rem;">
                    <!-- Icon -->
                    <div style="width: 80px; height: 80px; background: linear-gradient(135deg, #CC0000, #FF0000); border-radius: 16px; display: flex; align-items: center; justify-content: center; margin-bottom: 1.5rem;">
                        <svg style="width: 40px; height: 40px; color: white;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <ul style="list-style: none; padding: 0; margin-bottom: 2rem;">
                        <li style="display: flex; align-items: center; gap: 0.5rem; color: #666; font-size: 0.875rem; margin-bottom: 0.5rem;">
                            <svg style="width: 16px; height: 16px; color: #CC0000;" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/>
                            </svg>
                    ...
                    <!-- CTA -->
                    <div style="display: flex; align-items: center; justify-content: space-between; padding-top: 1.5rem; border-top: 1px solid #E5E5E5;">
                        <span style="font-weight: 600; color: #CC0000;">Gérer les plats</span>
                        <svg style="width: 20px; height: 20px; color: #CC0000;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                        </svg>
                    </div>
                </div>
