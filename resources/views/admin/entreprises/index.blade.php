...
@section('content')
    ...
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 2rem;">
        <div>
            <h2 style="font-size: 1.5rem; font-weight: 700; color: #3A3A3A;">Toutes les entreprises</h2>
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(350px, 1fr)); gap: 1.5rem;">
        ...
        <div class="card" style="overflow: hidden;">
            <!-- Header with Logo -->
            <div style="background: linear-gradient(135deg, #D9542A, #F7B801); padding: 2rem; text-align: center; position: relative;">
                @if($entreprise->logo)
                ...
                @else
                    <div style="width: 80px; height: 80px; margin: 0 auto; border-radius: 50%; background: white; display: flex; align-items: center; justify-content: center; font-size: 2rem; font-weight: 900; color: #D9542A;">
            ...
            <div style="padding: 1.5rem;">
                <h3 style="font-size: 1.25rem; font-weight: 700; color: #3A3A3A; margin-bottom: 1rem;">
                    {{ $entreprise->nom }}
                </h3>
                ...
                <div style="display: grid; gap: 0.75rem; margin-bottom: 1.5rem;">
                    ...
                    <div style="display: flex; gap: 0.5rem; align-items: flex-start;">
                        <svg style="width: 16px; height: 16px; color: #D9542A; flex-shrink: 0; margin-top: 2px;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div style="display: flex; gap: 0.5rem; padding-top: 1rem; border-top: 1px solid #E5E5E5;">
                    <a href="{{ route('admin.entreprises.edit', $entreprise->id) }}" style="flex: 1; padding: 0.625rem; background-color: #F7B801; color: white; border-radius: 6px; text-decoration: none; font-size: 0.875rem; font-weight: 600; text-align: center;">
                        ✏️ Modifier
                    </a>
                    <form action="{{ route('admin.entreprises.destroy', $entreprise->id) }}" method="POST" style="flex: 1;" onsubmit="return confirm('Êtes-vous sûr de vouloir supprimer cette entreprise ?');">
                        @csrf
                        @method('DELETE')
                        <button type="submit" style="width: 100%; padding: 0.625rem; background-color: #C62828; color: white; border: none; border-radius: 6px; font-size: 0.875rem; font-weight: 600; cursor: pointer;">
                            🗑️ Supprimer
                        </button>
                    </form>
                </div>
